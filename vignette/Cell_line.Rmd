...
```{r seqCAT,message=FALSE,warning=FALSE,eval=FALSE}
installation
...
# create SNV profiles
create_profile('HCT116b.filtered.ann.filtered.vcf','HCT116b','HCT116b.profile.txt')
...
hct116 <- read_profile("HCT116b.profile.txt", "HCT116b")
